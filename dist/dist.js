...
exports.transform = {
  hex2arr: function hex2arr(hex) {
    //no space
    var arr = [];
    for (var i = 0; i < hex.length; i += 2) {
      var num = parseInt(hex[i] + hex[i + 1], 16);
      if (num < 0 || num > 255) {
  ...
  binStr2arr: function binStr2arr(bin) {
    //string consisted of 0 and 1
    if (bin.length % 8) {
      throw new Error("binStr2arr can only parse octet bit string.");
    }
    var arr = [];
    for (var i = 0; i < bin.length; i += 8) {
      var num = parseInt(bin.substr(i, 8), 2);
      if (num < 0 || num > 255) {
        throw new Error("number is out of range");
      }
      arr.push(num);
  ...
  ascii2arr: function ascii2arr(str) {
    var arr = [];
    for (var i = 0; i < str.length; i++) {
      var num = str.charCodeAt(i) | 0;
      if (num < 0 || num > 255) {
        throw new Error("number is out of range");
      }
      arr.push(num);
  ...
  arr2ascii: function arr2ascii(arr) {
...
exports.events = new (__webpack_require__(42))();

exports.connect = function () {
  return new Promise(function (resolve, reject) {
    var sock = exports.socket = io();
...
exports.parse = function (byteArr) {};
exports.sendYPRT = function (yaw, pitch, roll, thro) {};
exports.motValTimer = null;
exports.lastMotVal = [];
exports.reduceSendingMotVal = function (motors) {
  if (exports.motValTimer) {
    exports.lastMotVal = motors;
  } else {
    exports.sendMotorValue(motors);

    exports.motValTimer = setTimeout(function () {
      exports.motValTimer = null;
...
exports.sendMotorValue = function (motors) {
  var toSend = [5];
  for (var i = 0; i < exports.motorLength; i++) {
...
module.exports = __webpack_require__(44)({
  ...
  methods: {
    ...
    attachEvt: function attachEvt() {
      var _this2 = this;

      setTimeout(function () {
        _this2.inputs = document.getElementsByTagName("input");
        ...
        var _loop = function _loop(i) {
          _this2.inputs[i].addEventListener("keyup", function (e) {
            ...
            if (e.keyCode == 53 && e.ctrlKey && e.shiftKey) {
              //C-%
              _this2.inputs[i].value += "<b>";
              return;
            }
            if (e.keyCode == 54 && e.ctrlKey && e.shiftKey) {
              //C-&
              _this2.inputs[i].value += "</b>";
              return;
            }
...
module.exports = function (_exports) {
  ...
  options.staticRenderFns = staticRenderFns
  if (false) {
    api.createRecord("data-v-21f5bf7a", options)
  }
  return _exports
}
var api = null
